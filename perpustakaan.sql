...
--
-- Host: localhost:3306
-- Generation Time: Dec 21, 2024 at 01:35 PM
...
('67643244193fb.jpeg', 'inf002', 'novel', 'game', 'ilham', 'ilham', '2024-12-16', 23, '0'),
('6764375898a7f.jpg', 'inf004', 'sains', 'sains', 'ilham', 'steve', '2024-12-02', 25, '0'),
('67643244193fb.jpeg', 'inf005', 'filsafat', 'olahraga', 'agus salim', 'ilham', '2024-12-16', 23, '0'),
('6766ba58bc9f2.jpg', 'inf006', 'filsafat', 'olahraga', 'agus salim', 'setiawan', '2024-12-21', 23, '0'),
...
(1234, '1m', 'muya', '$2y$10$eTRCJBrcF9JC9k2iSf46tusjnaQ6fVReYGwWuiNB2Q3FnAUE0hUm.', 'Perempuan', 'XII', '0891234567', '2011-04-05'),
(2345, '2', 'udin', '$2y$10$LSCYcVpiCuUCws/nVo7ro.yBAFcp5H2D1qJYuetSn2sc/jSAvavNa', 'Laki laki', 'X', '08908998892', '2024-12-21');
...
--
-- Table structure for table `riwayat_pengembalian`
--

CREATE TABLE `riwayat_pengembalian` (
  `id_pengembalian` int NOT NULL,
  `id_peminjaman` int NOT NULL,
...
--
-- Indexes for table `riwayat_pengembalian`
--
ALTER TABLE `riwayat_pengembalian`
  ADD PRIMARY KEY (`id_pengembalian`),
  ADD KEY `id_peminjaman` (`id_peminjaman`);
...
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;
...
--
-- AUTO_INCREMENT for table `riwayat_pengembalian`
--
ALTER TABLE `riwayat_pengembalian`
...
--
-- Constraints for table `riwayat_pengembalian`
--
ALTER TABLE `riwayat_pengembalian`
  ADD CONSTRAINT `riwayat_pengembalian_ibfk_1` FOREIGN KEY (`id_peminjaman`) REFERENCES `peminjaman` (`id_peminjaman`);
COMMIT;
